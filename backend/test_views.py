...
from .models import (
    User, Shop, Category, Product, ProductInfo, ProductParameter, 
    Parameter, Cart, CartItem, Contact, Order, OrderItem, EmailConfirmToken
)
from .serializers import (
    RegisterSerializer, LoginSerializer, PartnerUpdateSerializer,
    ProductSerializer, CartItemSerializer, ContactSerializer,
    ConfirmOrderSerializer, OrderSerializer
)
